...
> #### Gamma Distribution
>- Gamma Function:
> \begin{equation}\ulcorner(\alpha)\;=\;\int_{0}^{\infty}x^{\alpha-1}e^{-x}dx\end{equation}
>- Gamma function properties:
> \begin{equation}\ulcorner(\alpha\;+\;1)\;=\;\alpha\ulcorner(\alpha)\;=\;\alpha(\alpha\;-\;1)\ulcorner(\alpha\;-\;1\;=\;\alpha !)\end{equation}
> \begin{equation}\ulcorner(n)\;=\;(n\;-\;1)!\end{equation}
> thus:
> \begin{equation}\ulcorner(\alpha\;+\;1)\;=\;\int_{0}^{\infty}x^{\alpha}e^{-x}dx\end{equation}
